...
class HelpTableController: NarrowViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private func addIntro() {
        ...
        intro.addLabel("Advanced practice for experienced players. You must know the rules of 2 handed mahjong before playing. Rules are not enforced. There are lots of references online, but if you are a beginning player you should start with the American Mahjong Practice app before playing 2 handed.\n\nContact support@eightbam.com for help.")
        intro.expand()
