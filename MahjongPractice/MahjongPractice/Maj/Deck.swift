...
class Deck {
    ...
    func loadTiles() {
        ...
        for loop in 1...4 {
            for index in 1...9 {
                tiles.append(Tile(named: "\(index)dot", num: index, suit: "dot", id: index, sortId: index+10))
            }
            for index in 1...9 {
                tiles.append(Tile(named: "\(index)bam", num: index, suit: "bam", id: index+10, sortId: index+20))
            }
            for index in 1...9 {
                tiles.append(Tile(named: "\(index)crak", num: index, suit: "crak", id: index+20, sortId: index+30))
            }
            appendJoker()
            appendJoker()
            tiles.append(Tile(named: "red", num: 10, suit: "crak", id: 30, sortId: 43))
            tiles.append(Tile(named: "green", num: 10, suit: "bam", id: 20, sortId: 42))
            tiles.append(Tile(named: "soap", num: 10, suit: "dot", id: 10, sortId: 41 ))
            tiles.append(Tile(named: "north", num: 1, suit: "wnd", id: 31, sortId: 51))
            tiles.append(Tile(named: "south", num: 2, suit: "wnd", id: 32, sortId: 52))
            tiles.append(Tile(named: "west", num: 3, suit: "wnd", id: 33, sortId: 53))
            tiles.append(Tile(named: "east", num: 4, suit: "wnd", id: 34, sortId: 54))
            tiles.append(Tile(named: "f\(loop)", num: 12, suit: "flwr", id: 35, sortId: 1))
        }
        tiles.append(Tile(named: "sum", num: 12, suit: "flwr", id: 35, sortId: 2))
        tiles.append(Tile(named: "aut", num: 12, suit: "flwr", id: 35, sortId: 3))
        tiles.append(Tile(named: "win", num: 12, suit: "flwr", id: 35, sortId: 4))
        tiles.append(Tile(named: "spr", num: 12, suit: "flwr", id: 35, sortId: 5))
    }
    
    func appendJoker() {
        let joker = Tile(named: "joker", num: 11, suit: "jkr", id: 36, sortId: 55)
