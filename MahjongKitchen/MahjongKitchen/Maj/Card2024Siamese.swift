...
class Card2024Siamese : Card {
    ...
    func add369() {
        ...
        let p6 = add("3 66 999 3333 3333", mask: "g gg ggg rrrr 0000", note: "Kongs 3,6 or 9",  family: Family.f369, concealed: false, points: 25)
